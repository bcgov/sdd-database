...
export function validateBooleanField(value: unknown, label: string) {
  if (typeof value !== "boolean") {
    return `${label} must be enabled or disabled`;
  }
}
...
export function validateOfficeNumberField(
  value: string,
  label: string = "Office Number",
) {
  const requiredError = validateRequiredField(value, label);
  if (requiredError) {
    return requiredError;
...
export function validateEmployeeProgramAreaField(
  value: number,
  label: string = "Program Area",
) {
  const requiredError = validateRequiredField(value, label);
...
export function validateEmployeeJobTitleField(
  value: number | null,
...
export function validateAssetTagField(
  value: string,
...
export function validateOrderDateField(
  value: Date | DateValue,
  label: string = "Order Date",
) {
  /**
  ...
  const orderDate =
    value instanceof Date ? parseDate(value.toISOString().slice(0, 10)) : value;
...
export function validateGilrField(
  value: string,
  label: string = "GILR Number",
) {
...
export function validateRequiredSelectionField(value: number, label: string) {
  const requiredError = validateRequiredField(value, label);
  if (requiredError) {
    return requiredError;
  }
