...
export function WorkspaceDetails({
  ...
  const isResidentAssignmentType =
    selectedWorkspaceAssignmentType?.name === "Resident";

  const workspaceAssignmentBlockedReason =
    !hasOfficeAssignment && !hasProgramAreaAssignment
    ...
    <Accordion label="Workspace Details" id="workspaceDetails">
      <AssignmentSectionContent>
        <Select
          ...
          value={selectedWorkspaceAssignmentTypeId}
          onChange={(key) =>
            setSelectedWorkspaceAssignmentTypeId(
              key == null ? null : Number(key),
            )
          }
        ...
        {isResidentAssignmentType && (
          <>
            {workspaceAssignmentBlockedReason && (
              <Callout description={workspaceAssignmentBlockedReason}></Callout>
            )}
