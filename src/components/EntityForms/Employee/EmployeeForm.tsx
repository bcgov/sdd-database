...
} from "@/actions/entities/employee/actions";
...
export function EmployeeForm({
  ...
  const previousBranchIdRef = useRef<number | null>(
    employeeLookupState.selectedBranchId,
  );
  const previousProgramAreaIdRef = useRef<number | null>(
        ...
        >
          ...
          <WorkspaceDetails
            ...
            workspaceAssignmentTypes={
              employeeLookupState.workspaceAssignmentTypes
            }
            selectedWorkspaceAssignmentTypeId={
              employeeLookupState.selectedWorkspaceAssignmentTypeId
            }
            setSelectedWorkspaceAssignmentTypeId={
              employeeLookupState.setSelectedWorkspaceAssignmentTypeId
            }
          ...
          <WorkstationDetails
            workstationAssetTags={workstationAssetTags}
          ...
          <OhsAccommodations
            ohsAccommodationTypes={employeeLookupState.ohsAccommodationTypes}
            selectedOhsAccommodationTypeIds={
              employeeLookupState.selectedOhsAccommodationTypeIds
            }
          ></OhsAccommodations>
        </AccordionGroup>
      </div>
